...
CREATE TABLE IF NOT EXISTS dwh.customer_report_datamart (
    ...
    сustomer_address VARCHAR NOT NULL, -- адрес заказчика
    ...
    platform_money BIGINT NOT NULL, -- сумма, которую заработала платформа от покупок заказчика за месяц (10% от трат заказчика)
